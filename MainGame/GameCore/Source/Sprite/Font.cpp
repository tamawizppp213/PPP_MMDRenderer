...
namespace font
{
	bool CreateFontGennnokakuEnglish(std::unordered_map<FontType, FontInfo>& fontTable)
	{
		...
		fontTable[FontType::GenNoKaku_Gothic_English].PixelSizePerChar = gm::Float2(35.0f, 64.0f);
	...
	bool CreateFontGennnokakuNumber(std::unordered_map<FontType, FontInfo>& fontTable)
	{
		...
		fontTable[FontType::GenNoKaku_Gothic_Number].PixelSizePerChar = gm::Float2(51.2f, 64.0f);
