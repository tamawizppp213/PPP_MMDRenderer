...
//                          Implement
//////////////////////////////////////////////////////////////////////////////////
BoxShape::BoxShape(const Vector3& boxHalfExtents) : PolyhedralConvexShape()
{
	_shapeType = (int)BroadPhaseNativeTypes::Box_Shape;
...
*  @return 　　Vector3
*****************************************************************************/
Vector3 BoxShape::LocalGetSupportingVertex(const Vector3& vector) const
{
...
*  @return 　　Vector3
*****************************************************************************/
Vector3 BoxShape::LocalGetSupportingVertexWithoutMargin(const Vector3& vector) 
{
	Vector3 halfExtents = GetHalfExtentsWithoutMargin();
...
*  @return 　　void
*****************************************************************************/
void BoxShape::BatchedUnitVectorGetSupportingVertexWithoutMargin(const Vector3* vectors, Vector3* supportVerticesOut, int numVectors) const
{
...
*  @return 　　void
*****************************************************************************/
void BoxShape::CalculateLocalInertia(float mass, Vector3& inertia) const
{
...
*  @return 　　Vector3
*****************************************************************************/
Vector3 BoxShape::GetHalfExtentsWithMargin() const
{
	Vector3 halfExtents = GetHalfExtentsWithoutMargin();
	Vector3 margin      = Vector3(GetMargin(), GetMargin(), GetMargin());
	halfExtents        += margin;
...
*************************************************************************//**
*  @fn        const Vector3& BoxShape::GetHalfExtentsWithoutMargin() const
*  @brief     Get half extents without margin
*  @param[in] void
*  @return 　　void
*****************************************************************************/
const Vector3& BoxShape::GetHalfExtentsWithoutMargin() const
{
...
*  @return 　　void
*****************************************************************************/
void BoxShape::GetAABB(const AffineTransform& transform, Vector3& aabbMin, Vector3& aabbMax) const
{
...
*  @return 　　void
*****************************************************************************/
void BoxShape::GetPlane(Vector3& planeNormal, Vector3& planeSupport, int i) const
{
	Vector4 plane;
...
*  @return 　　void
*****************************************************************************/
void BoxShape::GetPreferredPenetrationDirection(int index, Vector3& penetrationVector) const
{
	switch (index)
	{
	case 0:
...
*  @return 　　void
*****************************************************************************/
void BoxShape::GetVertex(int index, Vector3& vertex) const
{
	Vector3 halfExtents = GetHalfExtentsWithMargin();
...
*  @return 　　void
*****************************************************************************/
void BoxShape::GetPlaneEquation(gm::Vector4& plane, int i) const
{
	Vector3 halfExtents = GetHalfExtentsWithoutMargin();
...
*  @return 　　void
*****************************************************************************/
void BoxShape::GetEdge(int i, Vector3& pa, Vector3& pb) const
{
	int edgeVert0 = 0;
	int edgeVert1 = 0;
...
*  @return 　　bool
*****************************************************************************/
bool BoxShape::IsInside(const Vector3& pt, float tolerance) const
{
	Vector3 halfExtents = GetHalfExtentsWithoutMargin();
...
*  @return 　　void
*****************************************************************************/
void BoxShape::SetMargin(float collisionMargin)
{
...
*  @return 　　void
*****************************************************************************/
void BoxShape::SetLocalScaling(const Vector3& scaling)
{
	Vector3 oldMargin = Vector3(GetMargin(), GetMargin(), GetMargin());
	Vector3 implicitShapeDimensionsWithMargin         = _implicitShapeDimensions + oldMargin;
...
#pragma endregion Private Funciton