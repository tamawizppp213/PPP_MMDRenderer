...
//                             Include
//////////////////////////////////////////////////////////////////////////////////
#include "GameCore/Include/Physics/Dynamics/Dynamics/DynamicsWorld.hpp"
...
void DiscreteDynamicsWorld::SetGravity(const Vector3& gravity)
{
	_gravity = gravity;
}
...
{
	for (auto& body : _nonStaticRigidBodies)
	{
		if (body->IsActive())
		{
			body->ApplyGravity();
...
Vector3 DiscreteDynamicsWorld::GetGravity() const
{
	return _gravity;
}
